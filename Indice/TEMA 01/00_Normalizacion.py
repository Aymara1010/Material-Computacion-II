...
st.subheader("📋:red[¿Por qué Normalizar?:]")
st.markdown("""<div class="justificar">
...
st.header("📊 Ventajas y Desventajas de la Normalización")
st.markdown("""<div class="justificar">
...
st.subheader("⚠️ ¿Qué anomalías de datos corrige la normalización?:")
st.markdown("""<div class="justificar">
...
with an1:
    with st.expander("📌 :red[**Inserción**]", expanded=True):
                st.markdown("""<div class="justificar">
...
with an2:
    with st.expander("📌 :red[**Eliminación**]", expanded=True):
                st.markdown("""<div class="justificar">
...
with an3:
    with st.expander("📌 :red[**Actualización**]", expanded=True):
                st.markdown("""<div class="justificar">
