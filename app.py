...
pg_01 = st.Page("Indice/GENERAL/01_Introduccion.py", title="Introducción")
...
pg_06 = st.Page("Indice/TEMA 02/01_NotacionDER.py", title="Fundamentos y Notación de DER")
...
pg = st.navigation({
    "**General**": [pg_00, pg_01],
    "**Tema 01: Normalización y Denormalización**": [pg_02, pg_03, pg_04],
